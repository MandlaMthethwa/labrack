 ...
 $firstname_error = $lastname_error = $password_error = $confirm_password_error = $username_error = "";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
       ...
       if(empty($_POST['username'])) {
          ...
          $sql = "SELECT lecturerID FROM lecturer WHERE lecturerUsername = ?";
       ...
       if(empty($firstname_error) && empty($lastname_error) && empty($username_error) 
        ...
        $sql = "INSERT INTO lecturer (lecturerFirstName, lecturerLastName, lecturerUsername, lecturerPassword) VALUES (?, ?, ?, ?)"; 
...
<span class="error"><?php echo $error;?></span><br>
 <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <a class="button-back" href="lecturers.php">Back</a>
</form> 
